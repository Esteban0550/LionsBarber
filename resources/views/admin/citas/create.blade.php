<x-admin-layout>
    <div class="py-6">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Nueva Cita</h1>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.citas.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="notas" name="notas" rows="3"
                                class="block mt-1 w-full border-gray-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white focus:border-amber-500 focus:ring-amber-500 rounded-md shadow-sm">{{ old('notas') }}</textarea>
                            @error('notas')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
